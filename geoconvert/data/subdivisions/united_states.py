...
us_state_code_regex = re.compile(rf"(?P<code>\b{codes}\b)", re.I)

street_types = r"\b|\b".join(street_type for street_type in US_STREET_TYPES)
us_postcode_regex = re.compile(
    r"(?P<postcode>\b\d{5}\b" + rf"(?!.+(\b{street_types}\b)))", re.I
)
